...
set_property IOSTANDARD LVCMOS18 [get_ports {ether_phy_rst_n}]
set_property PACKAGE_PIN J23 [get_ports {ether_phy_rst_n}]


set_property PACKAGE_PIN N26 [get_ports "sgmii_625MHZ_N"]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports "sgmii_625MHZ_N"]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports "sgmii_625MHZ_P"]
set_property PACKAGE_PIN P26 [get_ports "sgmii_625MHZ_P"]
